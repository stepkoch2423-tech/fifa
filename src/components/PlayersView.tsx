    ...
    <div className="space-y-6 panel-enter">
      <section className="rounded-[28px] border border-white/10 bg-slate-950/55 p-4 backdrop-blur sm:p-5">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-xs font-semibold text-slate-200">
        ...
        {filteredPlayers.map((player) => {
          ...
          return (
            ...
            >
              ...
              <div className="grid gap-3 sm:grid-cols-[104px_minmax(0,1fr)_82px]">
                <div className="relative h-[118px] overflow-hidden rounded-[20px] border border-white/8 bg-[#060c18]">
                  <img
                ...
                <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,39,0.82)_0%,rgba(10,15,28,0.92)_100%)] px-3 py-4 text-center">
                  <div className="text-[10px] uppercase tracking-[0.18em] text-slate-500">
                    OVR
                  </div>
                  <div className="mt-1 text-4xl font-black leading-none text-amber-300 tabular-nums">
                    {player.overall}
                  </div>
                  <div className="mt-2 text-[11px] text-slate-400">POT {player.potential}</div>
                </div>
              </div>
